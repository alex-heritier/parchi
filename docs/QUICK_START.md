...
If you run the billing/auth service, set the **Account API base URL** in Settings → Account & billing. This enables email sign-in, Stripe checkout, and the billing portal. See [BILLING.md](./BILLING.md) for setup.
