import { listProviderInstances, ensureProviderModel } from '../../../state/provider-registry.js';
...
const PROVIDER_SVGS: Record<string, string> = {
  anthropic: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M13.83 2 21 22h-4.2l-7.17-20h4.2ZM7.37 2 3 14.1 7.91 22H3L7.37 2Z"/></svg>',
  openai: '<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M12 6v6l4 2" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',
  ...
  codex: '<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M12 6v6l4 2" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',
  copilot: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" fill="none" stroke="currentColor" stroke-width="1.5"/></svg>',
  ...
  minimax: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M2 12h4l3-9 6 18 3-9h4" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  openrouter: '<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="5" r="3" fill="none" stroke="currentColor" stroke-width="1.5"/><circle cx="5" cy="19" r="3" fill="none" stroke="currentColor" stroke-width="1.5"/><circle cx="19" cy="19" r="3" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M12 8v3M7 17l3-4M17 17l-3-4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',
  parchi: '<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M8 14s1.5 2 4 2 4-2 4-2" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><circle cx="9" cy="10" r="1" fill="currentColor"/><circle cx="15" cy="10" r="1" fill="currentColor"/></svg>',
  custom: '<svg viewBox="0 0 24 24" fill="currentColor"><rect x="3" y="3" width="18" height="18" rx="3" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M9 9l6 6M15 9l-6 6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',
};
...
sidePanelProto.renderModelSelectorGrid = function renderModelSelectorGrid() {
  ...
  if (!providers.length) {
    grid.innerHTML = '<div class="model-selector-empty">Connect a provider in the Providers tab to see available models.</div>';
    return;
  }
...
sidePanelProto.selectModelFromGrid = function selectModelFromGrid(providerId: string, modelId: string) {
  ...
  this.configs[this.currentConfig] = config;
